...
{
    public class GetTotalTransactionAnalytics
    {
        private readonly ILogger<GetTotalTransactionAnalytics> _logger;
        private readonly ITransactionRepository _transactionRepository;

        public GetTotalTransactionAnalytics(ILogger<GetTotalTransactionAnalytics> logger, ITransactionRepository transactionRepository)
        {
            _logger = logger;
            _transactionRepository = transactionRepository;
        }

        [Function("GetTotalTransactionAnalytics")]
        public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get")] HttpRequest req)
        {
            ...
            return new OkObjectResult(await _transactionRepository.GetTotalTransactionAnalytics(
